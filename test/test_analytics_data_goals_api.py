...
from cervinodata_api.api.analytics_data_goals_api import AnalyticsDataGoalsApi  # noqa: E501
from cervinodata_api.rest import ApiException


class TestAnalyticsDataGoalsApi(unittest.TestCase):
    """AnalyticsDataGoalsApi unit test stubs"""

    def setUp(self):
        self.api = cervinodata_api.api.analytics_data_goals_api.AnalyticsDataGoalsApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_get_analytics_goal_report_per_campaign_per_day(self):
        """Test case for get_analytics_goal_report_per_campaign_per_day

        Return analytics goal report per campaign per day by organisation  # noqa: E501
        """
        pass

    def test_get_analytics_goal_report_per_channel_group_per_day(self):
        """Test case for get_analytics_goal_report_per_channel_group_per_day

        Return analytics goal report per channel group per day by organisation  # noqa: E501
        """
        pass

    def test_get_analytics_goal_report_per_device_per_day(self):
        """Test case for get_analytics_goal_report_per_device_per_day

        Return analytics goal report per device per day by organisation  # noqa: E501
        """
        pass

    def test_get_analytics_goal_report_per_source_medium_per_day(self):
        """Test case for get_analytics_goal_report_per_source_medium_per_day
