...
*AnalyticsDataDefaultMetricsApi* | [**get_analytics_report_per_device_per_channel_group_per_day**](docs/AnalyticsDataDefaultMetricsApi.md#get_analytics_report_per_device_per_channel_group_per_day) | **GET** /data/analytics-report-per-device-per-channel-group-per-day/{organisationUuid} | Return analytics report per device per channel group per day by organisation
...
*AnalyticsDataGoalsApi* | [**get_analytics_goal_report_per_device_per_channel_group_per_day**](docs/AnalyticsDataGoalsApi.md#get_analytics_goal_report_per_device_per_channel_group_per_day) | **GET** /data/analytics-goal-report-per-device-per-channel-group-per-day/{organisationUuid} | Return analytics goal report per device per channel group per day by organisation
