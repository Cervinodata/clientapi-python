...
class AnalyticsDataGoalsApi(object):
    ...
    def get_analytics_goal_report_per_campaign_per_day(self, organisation_uuid, **kwargs):  # noqa: E501
        ...
        return self.get_analytics_goal_report_per_campaign_per_day_with_http_info(organisation_uuid, **kwargs)  # noqa: E501

    def get_analytics_goal_report_per_campaign_per_day_with_http_info(self, organisation_uuid, **kwargs):  # noqa: E501
        """Return analytics goal report per campaign per day by organisation  # noqa: E501

        Analytics goal report per campaign per day by organisation  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_analytics_goal_report_per_campaign_per_day_with_http_info(organisation_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method get_analytics_goal_report_per_campaign_per_day" % key
                )
        ...
        if self.api_client.client_side_validation and ('organisation_uuid' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `organisation_uuid` when calling `get_analytics_goal_report_per_campaign_per_day`")  # noqa: E501
    ...
    def get_analytics_goal_report_per_channel_group_per_day(self, organisation_uuid, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_analytics_goal_report_per_channel_group_per_day_with_http_info(organisation_uuid, **kwargs)  # noqa: E501

    def get_analytics_goal_report_per_channel_group_per_day_with_http_info(self, organisation_uuid, **kwargs):  # noqa: E501
        """Return analytics goal report per channel group per day by organisation  # noqa: E501

        Analytics goal report per channel group per day by organisation  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_analytics_goal_report_per_channel_group_per_day_with_http_info(organisation_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_analytics_goal_report_per_channel_group_per_day" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'organisation_uuid' is set
        if self.api_client.client_side_validation and ('organisation_uuid' not in local_var_params or  # noqa: E501
                                                        local_var_params['organisation_uuid'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `organisation_uuid` when calling `get_analytics_goal_report_per_channel_group_per_day`")  # noqa: E501
    ...
    def get_analytics_goal_report_per_device_per_day(self, organisation_uuid, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_analytics_goal_report_per_device_per_day_with_http_info(organisation_uuid, **kwargs)  # noqa: E501

    def get_analytics_goal_report_per_device_per_day_with_http_info(self, organisation_uuid, **kwargs):  # noqa: E501
        """Return analytics goal report per device per day by organisation  # noqa: E501

        Analytics goal report per device per day by organisation  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_analytics_goal_report_per_device_per_day_with_http_info(organisation_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_analytics_goal_report_per_device_per_day" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'organisation_uuid' is set
        if self.api_client.client_side_validation and ('organisation_uuid' not in local_var_params or  # noqa: E501
                                                        local_var_params['organisation_uuid'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `organisation_uuid` when calling `get_analytics_goal_report_per_device_per_day`")  # noqa: E501
    ...
    def get_analytics_goal_report_per_source_medium_per_day(self, organisation_uuid, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_analytics_goal_report_per_source_medium_per_day_with_http_info(organisation_uuid, **kwargs)  # noqa: E501

    def get_analytics_goal_report_per_source_medium_per_day_with_http_info(self, organisation_uuid, **kwargs):  # noqa: E501
        """Return analytics goal report per source medium per day by organisation  # noqa: E501

        Analytics goal report per source medium per day by organisation  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_analytics_goal_report_per_source_medium_per_day_with_http_info(organisation_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_analytics_goal_report_per_source_medium_per_day" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'organisation_uuid' is set
        if self.api_client.client_side_validation and ('organisation_uuid' not in local_var_params or  # noqa: E501
                                                        local_var_params['organisation_uuid'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `organisation_uuid` when calling `get_analytics_goal_report_per_source_medium_per_day`")  # noqa: E501
