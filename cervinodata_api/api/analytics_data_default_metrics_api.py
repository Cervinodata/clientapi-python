...
class AnalyticsDataDefaultMetricsApi(object):
    ...
    def get_analytics_report_per_device_per_channel_group_per_day(self, organisation_uuid, **kwargs):  # noqa: E501
        """Return analytics report per device per channel group per day by organisation  # noqa: E501

        Analytics report per device per channel group per day by organisation  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_analytics_report_per_device_per_channel_group_per_day(organisation_uuid, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_analytics_report_per_device_per_channel_group_per_day_with_http_info(organisation_uuid, **kwargs)  # noqa: E501

    def get_analytics_report_per_device_per_channel_group_per_day_with_http_info(self, organisation_uuid, **kwargs):  # noqa: E501
        """Return analytics report per device per channel group per day by organisation  # noqa: E501

        Analytics report per device per channel group per day by organisation  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_analytics_report_per_device_per_channel_group_per_day_with_http_info(organisation_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_analytics_report_per_device_per_channel_group_per_day" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'organisation_uuid' is set
        if self.api_client.client_side_validation and ('organisation_uuid' not in local_var_params or  # noqa: E501
                                                        local_var_params['organisation_uuid'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `organisation_uuid` when calling `get_analytics_report_per_device_per_channel_group_per_day`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/data/analytics-report-per-device-per-channel-group-per-day/{organisationUuid}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
