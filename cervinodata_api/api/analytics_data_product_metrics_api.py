...
class AnalyticsDataProductMetricsApi:
    ...
    @validate_call
    def get_ga4_report_per_product_name_per_organisation_per_property_per_week(
        self,
        ...
        _param = self._get_ga4_report_per_product_name_per_organisation_per_property_per_week_serialize(
    ...
    @validate_call
    def get_ga4_report_per_product_name_per_organisation_per_property_per_week_with_http_info(
        self,
        organisation_uuids: Annotated[List[StrictStr], Field(description="Organisation uuids")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_ga4_report_per_product_name_per_organisation_per_property_per_week_without_preload_content(
        self,
        organisation_uuids: Annotated[List[StrictStr], Field(description="Organisation uuids")],
        _request_timeout: Union[
            None,
    ...
    def _get_ga4_report_per_product_name_per_organisation_per_property_per_week_serialize(
        self,
        organisation_uuids,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/data/ga4-report-per-product-name-per-organisation-per-property-per-week/{organisationUuids}',
    ...
    @validate_call
    def get_ga4_report_per_product_sku_per_organisation_per_property_per_week(
        self,
        organisation_uuids: Annotated[List[StrictStr], Field(description="Organisation uuids")],
        _request_timeout: Union[
            None,
        ...
        _param = self._get_ga4_report_per_product_sku_per_organisation_per_property_per_week_serialize(
            organisation_uuids=organisation_uuids,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_ga4_report_per_product_sku_per_organisation_per_property_per_week_with_http_info(
        self,
        organisation_uuids: Annotated[List[StrictStr], Field(description="Organisation uuids")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_ga4_report_per_product_sku_per_organisation_per_property_per_week_without_preload_content(
        self,
        organisation_uuids: Annotated[List[StrictStr], Field(description="Organisation uuids")],
        _request_timeout: Union[
            None,
    ...
    def _get_ga4_report_per_product_sku_per_organisation_per_property_per_week_serialize(
        self,
        organisation_uuids,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/data/ga4-report-per-product-sku-per-organisation-per-property-per-week/{organisationUuids}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
