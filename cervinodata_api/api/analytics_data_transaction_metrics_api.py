...
class AnalyticsDataTransactionMetricsApi:
    ...
    @validate_call
    def get_ga4_report_per_campaign_per_organisation_per_property(
        self,
        ...
        _param = self._get_ga4_report_per_campaign_per_organisation_per_property_serialize(
    ...
    @validate_call
    def get_ga4_report_per_campaign_per_organisation_per_property_with_http_info(
        self,
        organisation_uuids: Annotated[List[StrictStr], Field(description="Organisation uuids")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_ga4_report_per_campaign_per_organisation_per_property_without_preload_content(
        self,
        organisation_uuids: Annotated[List[StrictStr], Field(description="Organisation uuids")],
        _request_timeout: Union[
            None,
    ...
    def _get_ga4_report_per_campaign_per_organisation_per_property_serialize(
        self,
        organisation_uuids,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/data/ga4-report-per-campaign-per-organisation-per-property/{organisationUuids}',
    ...
    @validate_call
    def get_ga4_report_per_campaign_per_organisation_per_property_per_month(
        self,
        organisation_uuids: Annotated[List[StrictStr], Field(description="Organisation uuids")],
        _request_timeout: Union[
            None,
        ...
        _param = self._get_ga4_report_per_campaign_per_organisation_per_property_per_month_serialize(
            organisation_uuids=organisation_uuids,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_ga4_report_per_campaign_per_organisation_per_property_per_month_with_http_info(
        self,
        organisation_uuids: Annotated[List[StrictStr], Field(description="Organisation uuids")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_ga4_report_per_campaign_per_organisation_per_property_per_month_without_preload_content(
        self,
        organisation_uuids: Annotated[List[StrictStr], Field(description="Organisation uuids")],
        _request_timeout: Union[
            None,
    ...
    def _get_ga4_report_per_campaign_per_organisation_per_property_per_month_serialize(
        self,
        organisation_uuids,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/data/ga4-report-per-campaign-per-organisation-per-property-per-month/{organisationUuids}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
