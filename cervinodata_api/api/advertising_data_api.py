...
class AdvertisingDataApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_adform_extended_report_per_organisation_per_campaign_per_creative_per_day_endpoint = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [
                    'bearerAuth'
                ],
                'endpoint_path': '/data/adform-extended-report-per-organisation-per-campaign-per-creative-per-day/{organisationUuids}',
                'operation_id': 'get_adform_extended_report_per_organisation_per_campaign_per_creative_per_day',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_adform_extended_report_per_organisation_per_campaign_per_line_item_per_day_endpoint = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [
                    'bearerAuth'
                ],
                'endpoint_path': '/data/adform-extended-report-per-organisation-per-campaign-per-line-item-per-day/{organisationUuids}',
                'operation_id': 'get_adform_extended_report_per_organisation_per_campaign_per_line_item_per_day',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_adform_extended_report_per_organisation_per_campaign_per_creative_per_day(
        self,
        organisation_uuids,
        **kwargs
    ):
        """Return adform extended report per organisation per campaign per creative per day  # noqa: E501

        Adform extended report per organisation per campaign per creative per day  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_adform_extended_report_per_organisation_per_campaign_per_creative_per_day(organisation_uuids, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['organisation_uuids'] = \
            organisation_uuids
        return self.get_adform_extended_report_per_organisation_per_campaign_per_creative_per_day_endpoint.call_with_http_info(**kwargs)

    def get_adform_extended_report_per_organisation_per_campaign_per_line_item_per_day(
        self,
        organisation_uuids,
        **kwargs
    ):
        """Return adform extended report per organisation per campaign per line item per day  # noqa: E501

        Adform extended report per organisation per campaign per line item per day  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_adform_extended_report_per_organisation_per_campaign_per_line_item_per_day(organisation_uuids, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['organisation_uuids'] = \
            organisation_uuids
        return self.get_adform_extended_report_per_organisation_per_campaign_per_line_item_per_day_endpoint.call_with_http_info(**kwargs)
