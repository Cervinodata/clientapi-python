...
from cervinodata_api import rest
from cervinodata_api.configuration import Configuration
from cervinodata_api.exceptions import ApiTypeError, ApiValueError, ApiException
from cervinodata_api.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AdvertisingDataApi()
        api_instance.get_ad_account_report_per_organisation_per_day  # this is an instance of the class Endpoint
        api_instance.get_ad_account_report_per_organisation_per_day()  # this invokes api_instance.get_ad_account_report_per_organisation_per_day.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_ad_account_report_per_organisation_per_day.callable or self.callable in this class
