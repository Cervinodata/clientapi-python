...
# **get_adform_extended_report_per_organisation_per_account_per_campaign_per_creative_per_day**
> str get_adform_extended_report_per_organisation_per_account_per_campaign_per_creative_per_day(organisation_uuids)
...
with cervinodata_api.ApiClient(configuration) as api_client:
    ...
    try:
        # Return adform extended report per organisation per account per campaign per creative per day
        api_response = api_instance.get_adform_extended_report_per_organisation_per_account_per_campaign_per_creative_per_day(organisation_uuids)
        pprint(api_response)
    except cervinodata_api.ApiException as e:
...
# **get_adform_extended_report_per_organisation_per_account_per_campaign_per_day**
> str get_adform_extended_report_per_organisation_per_account_per_campaign_per_day(organisation_uuids)
...
with cervinodata_api.ApiClient(configuration) as api_client:
    ...
    try:
        # Return adform extended report per organisation per account per campaign per day
        api_response = api_instance.get_adform_extended_report_per_organisation_per_account_per_campaign_per_day(organisation_uuids)
        pprint(api_response)
    except cervinodata_api.ApiException as e:
...
> str get_adform_extended_report_per_organisation_per_account_per_campaign_per_line_item_per_day(organisation_uuids)
...
with cervinodata_api.ApiClient(configuration) as api_client:
    ...
    try:
        # Return adform extended report per organisation per account per campaign per line item per day
        api_response = api_instance.get_adform_extended_report_per_organisation_per_account_per_campaign_per_line_item_per_day(organisation_uuids)
        pprint(api_response)
    except cervinodata_api.ApiException as e:
