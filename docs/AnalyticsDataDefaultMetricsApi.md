...
[**get_analytics_report_per_device_per_channel_group_per_day**](AnalyticsDataDefaultMetricsApi.md#get_analytics_report_per_device_per_channel_group_per_day) | **GET** /data/analytics-report-per-device-per-channel-group-per-day/{organisationUuid} | Return analytics report per device per channel group per day by organisation
...
# **get_analytics_report_per_device_per_channel_group_per_day**
> str get_analytics_report_per_device_per_channel_group_per_day(organisation_uuid, from_date=from_date, date_format=date_format, format=format)

Return analytics report per device per channel group per day by organisation

Analytics report per device per channel group per day by organisation
...
try:
    # Return analytics report per device per channel group per day by organisation
    api_response = api_instance.get_analytics_report_per_device_per_channel_group_per_day(organisation_uuid, from_date=from_date, date_format=date_format, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling AnalyticsDataDefaultMetricsApi->get_analytics_report_per_device_per_channel_group_per_day: %s\n" % e)
```
